		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#JepcoISUDMsmartmeter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"JepcoISUDMsmartmeter-display": {
								"semanticObject": "JepcoISUDMsmartmeter",
								"action": "display",
								"description": "Smart Meter Replacement.",
								"title": "Smart Meter Replacement",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Jepco.ISU.DM.smartmeter",
									"url": sap.ui.require.toUrl("Jepco/ISU/DM/smartmeter")
								}
							}
						}
					}
